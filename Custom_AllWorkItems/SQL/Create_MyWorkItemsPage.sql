...
DECLARE @NavNodeGuid nvarchar(255)                  = '7666c471-6804-489b-b0a5-cc5948dd3262' 
DECLARE @ViewPanelGuid nvarchar(255)                = '5f33f31c-2b70-4ed0-9a35-face4638b5ba'
DECLARE @DataSourceGuid nvarchar(255) 				= '80adcb84-74e6-4309-95c9-bdde0fdffe11'


-- set the page title and the default language
DECLARE @MenuTitle nvarchar(255)  		= 'My Work Items'
DECLARE @PageTitle nvarchar(255)		= 'My Work Items Page'
